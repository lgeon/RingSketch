...
SketchPart<init_mem_in_bytes>::SketchPart()
{
    this->clear();
...
template<int init_mem_in_bytes>
void SketchPart<init_mem_in_bytes>::clear()
{
...
template<int init_mem_in_bytes>
void SketchPart<init_mem_in_bytes>::insert(uint8_t *key, int keylen, int f)
{
...
template<int init_mem_in_bytes>
void SketchPart<init_mem_in_bytes>::swap_insert(uint8_t *key, int f)
{
    uint32_t hash_val = (uint32_t)bobhash->run((const char*)key, KEY_LENGTH_4);
    uint32_t pos = hash_val % (uint32_t)counter_num;
...
template<int init_mem_in_bytes>
int SketchPart<init_mem_in_bytes>::query(uint8_t *key) 
{
    uint32_t hash_val = (uint32_t)bobhash->run((const char*)key, KEY_LENGTH_4);
    uint32_t pos = hash_val % (uint32_t)counter_num;
...
// template<int init_mem_in_bytes>
// void SketchPart<init_mem_in_bytes>::compress(int ratio, uint8_t *dst) 
// {
...
// template<int init_mem_in_bytes>
// int SketchPart<init_mem_in_bytes>::query_compressed_part(uint8_t *key, uint8_t *compress_part, int compress_counter_num) 
// {
//     uint32_t hash_val = (uint32_t)bobhash->run((const char *)key, KEY_LENGTH_4);
...
// template<int init_mem_in_bytes>
// int SketchPart<init_mem_in_bytes>::get_compress_width(int ratio)
// {
//     return (counter_num / ratio);
// }

// template<int init_mem_in_bytes>
// int SketchPart<init_mem_in_bytes>::get_compress_memory(int ratio){
//     return (uint32_t)(counter_num / ratio);
// }

// template<int init_mem_in_bytes>
// int SketchPart<init_mem_in_bytes>::get_memory_usage()
// {
//     return counter_num;
// }

// template<int init_mem_in_bytes>
// int SketchPart<init_mem_in_bytes>::get_cardinality() 
// {
//     int mice_card = 0;
//     for (int i = 1; i < 256; i++)
...
// template<int init_mem_in_bytes>
// void SketchPart<init_mem_in_bytes>::get_entropy(int &tot, double &entr)
// {
//     for (int i = 1; i < 256; i++) 
//     {
//         tot += mice_dist[i] * i;
...
// template<int init_mem_in_bytes>
// void SketchPart<init_mem_in_bytes>::get_distribution(vector<double> &dist) 
// {
